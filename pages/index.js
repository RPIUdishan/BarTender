  ...
  return (
    <div className="bg-[#d26931] bg-cover w-full h-full scroll-smooth pb-2">
      ...
      <div className="mt-8 flex items-center justify-center ">
        <a href="#search">
          <div className="border-solid border-white border-2 rounded-full animate-pulse cursor-pointer flex justify-center items-center">
            ...
            <p className="text-white p-2">Our Drinks</p>
          </div>
        </a>
      </div>

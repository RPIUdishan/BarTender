                ...
                <div className='flex justify-end'>

                    {
                        highlightBox ?
                            ...
                            :
                            <div className='border-2 border-[#510578] border-solid p-1 mr-2 rounded-xl cursor-pointer bg-[#510578]' onClick={boxShape}>
                    ...
                    {
                        highlightLine ?
                            <div className='border-2 border-[#510578] border-solid p-1 ml-2 rounded-xl cursor-pointer bg-[#510578]' onClick={lineShape}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-white">

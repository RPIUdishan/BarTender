...
const search = () => {
    return (
        <div className='mx-[15px] my-[10px] relative'>
            ...
            <button className='bg-[#510578] w-36 h-12 rounded-3xl py-3 absolute right-0 top-0 bottom-0  flex items-center justify-center' type='button' onClick={dummyCall}>

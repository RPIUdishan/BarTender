...
const search = () => {
    return (
        <div className='mx-[15px] my-[10px] relative'>
            <input type="search" name="search" placeholder="Search" class="bg-[#e4d2fc] h-12 w-full px-5 pr-20 rounded-full text-sm focus:outline-none placeholder:text-black" />
